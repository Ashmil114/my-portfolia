    ...
    <div className='h-screen '>
        ...
        {/* <svg className='ml-[16%]  invisible lg:visible  absolute' xmlns="http://www.w3.org/2000/svg" width="804" height="134" viewBox="0 0 804 134" fill="none"><path d="M802 0V52H2V284" stroke="#EBFF00" stroke-width="4"/></svg> */}
            <div className='lg:w-[50%]  lg:h-screen lg:flex lg:justify-center lg:flex-col h-screen flex '>
                <h1 className='lg:text-[360px] lg:font-[600]  text-[#EBFF00] lg:ml-[1rem] lg:p-1 text-[120px] lg:relative absolute -bottom-[300%] lg:bottom-0 ml-3 md:text-[150px]'>03</h1>
            ...
            <div className='lg:w-[50%]  lg:h-screen lg:flex lg:flex-col lg:items-center lg:justify-center lg:relative   ' >
              ...
              <div className='lg:flex lg:gap-4  lg:justify-normal lg:w-auto w-full flex '>
                  <div className='lg:w-[70px] lg:h-[70px] text-center w-[50px] h-[50px]'>
                    <a href="/"><BsInstagram className='text-black lg:text-[70px] '/></a>
                  </div>
                  <div className='lg:w-[70px] lg:h-[70px] text-center w-[50px] h-[50px]'>
                    <a href="/"><BsLinkedin className='text-black lg:text-[70px] '/></a>
                  </div>
                  <div className='lg:w-[70px] lg:h-[70px] text-center w-[50px] h-[50px]'>
                    <a href="/"><BsGithub className='text-black lg:text-[70px] '/></a>
                  </div>

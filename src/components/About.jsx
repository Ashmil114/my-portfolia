    ...
    <div  >
        <div className='h-screen ' id='about'>
          ...
          {/* <svg className='ml-[17.45%]  invisible lg:visible  absolute' xmlns="http://www.w3.org/2000/svg" width="440" height="150" viewBox="0 0 440 150" fill="none"><path d="M438 0V52H2V280" stroke="#EBFF00" stroke-width="4"/></svg> */}
              <div className='lg:w-[50%]  lg:h-screen lg:flex lg:justify-center lg:flex-col h-screen flex '>
                  <h1 className='lg:text-[360px] lg:font-[600]  text-[#EBFF00] lg:ml-[1rem] lg:p-1 text-[120px] lg:relative absolute -bottom-[100%] lg:bottom-0 ml-3 md:text-[150px]'>01</h1>
                  <h1 className='lg:text-[40px] lg:-mt-[7rem] lg:ml-[7rem] text-[40px] w-full lg:relative  flex justify-center lg:justify-normal mt-9 '>ABOUT ME</h1>
              ...
              <div className='lg:w-[50%]  lg:h-screen lg:flex lg:flex-col lg:items-center lg:justify-center lg:relative absolute -bottom-[75%]   lg:-bottom-0 flex  flex-col w-full  items-center ' >
